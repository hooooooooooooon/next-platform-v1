    ...
    <div className="flex flex-col gap-2">
      <div className="relative mt-4">
        <input
          ...
          {...rest}
        />
        <label className="pointer-events-none absolute bottom-2 left-2 z-0 text-base capitalize text-neutral-400 transition-all duration-300 peer-valid/input:bottom-8 peer-valid/input:text-xs peer-valid/input:font-bold peer-focus/input:bottom-8 peer-focus/input:text-xs peer-focus/input:font-bold peer-focus/input:text-[#120A8F]">
          {name}
        </label>
        <span className="absolute bottom-0 left-0 block h-0.5 w-0 rounded-sm bg-[#120A8F] duration-300 peer-valid/input:w-full peer-focus/input:w-full"></span>
